...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    name: "DataPea",
    emoji: "Smartphone",
    desc: "Fast, reliable VTU app for buying mobile data and airtime, paying utility bills, and managing cable TV subscriptions in Nigeria. Features instant delivery, secure payments, cashback rewards, and tools designed for VTU agents and businesses.",
    stack: ["React Native", "TypeScript", "Expo", "Native Modules"],
    tag: "Fintech",
    year: "2024",
    featured: true,
    platform: "both",
    appStore: "https://apps.apple.com/us/app/datapea/id6758883404",
    playStore: "https://play.google.com/store/apps/details?id=com.datapea",
    images: [
      "/datapea-1.webp",
      "/datapea-2.webp",
      "/datapea-3.webp",
  ...
  },
  {
    ...
    name: "UlamaData",
    emoji: "CreditCard",
    desc: "Affordable digital service platform for everyday bill payments in Nigeria. Buy cheap data, airtime, electricity, and cable TV instantly at discounted rates. Perfect for personal use and data resale businesses with instant delivery and secure transactions.",
    stack: ["React Native", "TypeScript", "Expo", "AsyncStorage"],
    tag: "Fintech",
    year: "2024",
    featured: true,
    platform: "both",
    appStore: "https://apps.apple.com/us/app/ulamadata/id6760598685",
    // playStore: "https://play.google.com/store/apps/details?id=com.ulamadata",
    images: [
      "/ulamadata-1.webp",
      "/ulamadata-2.webp",
      "/ulamadata-3.webp",
